...
export default function History() {
  return (
    <section className="relative flex min-h-screen flex-col items-center gap-6 overflow-hidden px-6 py-20 md:py-36 md:pt-12 lg:flex-row lg:gap-y-0 lg:px-24">
      ...
      <div className="flex-[3] space-y-6">
        <h2 className="text-3xl font-bold capitalize md:text-4xl lg:text-5xl">
          SEJARAH
          <span className="text-secondary"> IKATAN BUJANG GADIS UNSRI</span>
        </h2>
