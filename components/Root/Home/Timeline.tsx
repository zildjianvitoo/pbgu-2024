...
const timelineData = [
  {
    title: "Registration",
    content: (
      <p className="text-end text-xl font-bold text-primary lg:text-2xl">
...
export default function Timeline() {
  ...
  return (
    <div
      className="flex w-full flex-col gap-12 bg-primary/5 bg-white px-6 py-20 md:py-24 lg:flex-row lg:px-24"
      ref={containerRef}
    >
      <div className="flex-[2] space-y-6 lg:mt-32">
        <h2 className="text-3xl font-bold capitalize md:text-4xl lg:text-5xl">
          Timeline <span className="text-primary">Agenda IBG UNSRI</span>
        </h2>
